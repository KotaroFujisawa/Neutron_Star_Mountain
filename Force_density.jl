...
#                - π^2*(-6*R^5/r + 3*R^3*π^2*r)*sin(π*r/R)/R^2)
    ...
    function set_magnetic_stress(A, r_c, r_o, R, j_0, j_1)
        ...
        m_rr_co(r) = A*4*R*(4*(-3*R*(2*R^2 - π^2*r^2)*sin(π*r/R) + π*r*(6*R^2*cos(π*r/R) + π^2*r^2) 
        + 3*r^3*(j_0 + j_1))^2 - (3*R*(2*R^2 + π^2*r^2)*sin(π*r/R) + 2*π^2*r^2*(-3*R*sin(π*r/R) + π*r) 
        - 3*π*r*(2*R^2 - π^2*r^2)*cos(π*r/R) + 6*r^3*(j_0 + j_1))^2)/(27*π^4*r^6)

        m_rr_cr(r) = A*4*R*(4*(-3*R*(2*R^2 - π^2*r^2)*sin(π*r/R) + 3*j_0*r_c^3 + 3*j_1*r^3 
        + π*r*(6*R^2*cos(π*r/R) + π^2*r^2))^2 - (3*R*(2*R^2 + π^2*r^2)*sin(π*r/R) - 3*j_0*r_c^3 
        + 6*j_1*r^3 + 2*π^2*r^2*(-3*R*sin(π*r/R) + π*r) - 3*π*r*(2*R^2 - π^2*r^2)*cos(π*r/R))^2)/(27*π^4*r^6)

        m_rr_oc(r) = A*4*R*(4*(-3*R*(2*R^2 - π^2*r^2)*sin(π*r/R) + 3*j_0*r_c^3 + 3*j_1*r_o^3 
        + π*r*(6*R^2*cos(π*r/R) + π^2*r^2))^2 - (3*R*(2*R^2 + π^2*r^2)*sin(π*r/R) - 3*j_0*r_c^3 
        - 3*j_1*r_o^3 + 2*π^2*r^2*(-3*R*sin(π*r/R) + π*r) - 3*π*r*(2*R^2 - π^2*r^2)*cos(π*r/R))^2)/(27*π^4*r^6)
        ...
        + π*r*(6*R^2*cos(π*r/R) + π^2*r^2))*(3*R*(2*R^2 + π^2*r^2)*sin(π*r/R) - 2*π^2*r^2*(3*R*sin(π*r/R) - π*r) 
        - 3*π*r*(2*R^2 - π^2*r^2)*cos(π*r/R) + 6*r^3*(j_0 + j_1))/(27*π^4*r^6) / r
